  ...
  function formValidation() {
    if ($.exists('#contact-form #submit')) {
      ...
      $('#contact-form #submit').on('click', function () {
        ...
        if (!regex.test(email)) {
          $('#st-alert').fadeIn().html('<div class="alert alert-danger"><strong>Attention !</strong> Veuillez renseigner un email valide.</div>');
          return false;
        }
        ...
        if (name != '' && email != '' && msg != '') {
          ...
          $('#st-alert').fadeIn().html('<div class="alert alert-danger"><strong>Attention !</strong> Tout les champs sont obligatoires.</div>');
        }
        return false;
      });
    }
